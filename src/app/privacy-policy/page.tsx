      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="space-y-6 text-foreground/80">
            ...
            <h2 className="pt-6 border-t">1. Information We Collect</h2>
            <p>
            ...
            <h2 className="pt-6 border-t">2. How We Use Your Information</h2>
            <p>
            ...
            <h2 className="pt-6 border-t">3. Sharing of Information</h2>
            ...
            <h2 className="pt-6 border-t">4. Cookies & Tracking Technologies</h2>
            <p>
            ...
            <h2 className="pt-6 border-t">5. Third-Party Links</h2>
            <p>
            ...
            <h2 className="pt-6 border-t">6. Data Security</h2>
            <p>
            ...
            <h2 className="pt-6 border-t">7. Your Rights</h2>
            ...
            <h2 className="pt-6 border-t">8. Data Retention</h2>
            <p>
            ...
            <h2 className="pt-6 border-t">9. Use of WhatsApp Communication</h2>
            ...
            <h2 className="pt-6 border-t">10. Policy on Children’s Data</h2>
            <p>
              Our services are not intended for individuals under the age of 18. We
              do not knowingly collect data from minors.
            </p>

            <h2 className="pt-6 border-t">11. Changes to This Privacy Policy</h2>
            <p>
            ...
            <h2 className="pt-6 border-t">12. Contact Us</h2>
            <p>
