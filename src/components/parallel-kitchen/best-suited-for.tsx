...
import { StretchHorizontal, Users, Droplets } from 'lucide-react';
import { cn } from "@/lib/utils";

const items = [
    { text: 'Narrow kitchen spaces', icon: <StretchHorizontal className="size-8 text-primary" /> },
    { text: 'Families who cook frequently', icon: <Users className="size-8 text-primary" /> },
    { text: 'Homes needing separate wet & dry zones', icon: <Droplets className="size-8 text-primary" /> },
];
