...
import { Gem, Archive, Users, Settings } from "lucide-react";

export function WhyChoose() {
  const features = [
    {
      title: "Adds a Luxury Feel",
      description:
        "The island becomes the focal point of your home.",
      icon: <Gem className="size-8" />,
    },
    {
      title: "Additional Storage & Workspace",
      description:
        "Perfect for meal prep, serving, or cooking.",
      icon: <Archive className="size-8" />,
    },
    {
      title: "Great for Socializing",
      description:
        "Ideal for families that entertain guests often.",
      icon: <Users className="size-8" />,
    },
    {
      title: "Highly Customizable",
      description:
        "Choose a breakfast counter, bar seating, sink island, or hob island.",
    ...
    <section className="bg-background relative z-10 py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto">
              <h2 className="text-3xl font-semibold text-center md:text-4xl">Why Choose an Island Kitchen?</h2>
            </div>
