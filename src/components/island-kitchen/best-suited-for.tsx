...
import { Maximize, Sofa, Gem } from 'lucide-react';
import { cn } from "@/lib/utils";

const items = [
    { text: 'Spacious kitchens', icon: <Maximize className="size-8 text-primary" /> },
    { text: 'Open living-dining layouts', icon: <Sofa className="size-8 text-primary" /> },
    { text: 'Modern premium homes', icon: <Gem className="size-8 text-primary" /> },
];
