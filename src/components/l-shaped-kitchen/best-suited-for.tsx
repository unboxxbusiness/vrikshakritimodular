...
export function BestSuitedFor() {
  const bestSuitedForImage = PlaceHolderImages.find(img => img.id === 'l-shaped-best-for-1');

  const items = [
    'Apartments with compact kitchens',
    'Homes requiring multi-functional open layouts',
    'Families wanting a clean, minimal aesthetic',
  ];
