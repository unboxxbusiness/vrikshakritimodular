...
import { Home, RefreshCw, Wallet, BedDouble } from 'lucide-react';
import { cn } from "@/lib/utils";

const items = [
    { text: 'Homes with existing civil kitchens', icon: <Home className="size-8 text-primary" /> },
    { text: 'Quick makeovers', icon: <RefreshCw className="size-8 text-primary" /> },
    { text: 'Budget renovations', icon: <Wallet className="size-8 text-primary" /> },
    { text: 'Rental property improvements', icon: <BedDouble className="size-8 text-primary" /> },
];
