...
export function BestSuitedFor() {
  const bestSuitedForImage = PlaceHolderImages.find(img => img.id === 'u-shaped-best-for-1');

  const items = [
    'Large Indian households',
    'Those who batch-cook or prepare multiple dishes daily',
    'Homes with spacious kitchen rooms',
  ];
