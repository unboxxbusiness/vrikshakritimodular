...
import { Users, CookingPot, Home } from 'lucide-react';
import { cn } from "@/lib/utils";

const items = [
    { text: 'Large Indian households', icon: <Users className="size-8 text-primary" /> },
    { text: 'Those who batch-cook or prepare multiple dishes daily', icon: <CookingPot className="size-8 text-primary" /> },
    { text: 'Homes with spacious kitchen rooms', icon: <Home className="size-8 text-primary" /> },
];
