...
import { Home, BedDouble, Sofa } from 'lucide-react';
import { cn } from "@/lib/utils";

const items = [
    { text: 'Compact homes', icon: <Home className="size-8 text-primary" /> },
    { text: 'Rental properties', icon: <BedDouble className="size-8 text-primary" /> },
    { text: 'Open living-dining areas needing a simple layout', icon: <Sofa className="size-8 text-primary" /> },
];
