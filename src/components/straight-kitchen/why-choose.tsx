...
import { Home, Sparkles, Wallet, Hand } from "lucide-react";

export function WhyChoose() {
  const features = [
    {
      title: "Ideal for Small Spaces",
      description:
        "Perfect for studio apartments, 1BHK/2BHK homes, or utility kitchens.",
      icon: <Home className="size-8" />,
    },
    {
      title: "Clean & Minimal Look",
      description:
        "A single-wall layout keeps the design elegant and clutter-free.",
      icon: <Sparkles className="size-8" />,
    },
    {
      title: "Cost-Effective",
      description:
        "Requires fewer cabinets and accessories while still being efficient.",
      icon: <Wallet className="size-8" />,
    },
    {
      title: "Easy to Maintain",
      description:
        "Fewer corners and surfaces make cleaning effortless.",
    ...
    <section className="bg-background relative z-10 py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto">
              <h2 className="text-3xl font-semibold text-center md:text-4xl">Why Choose a Straight Kitchen?</h2>
            </div>
