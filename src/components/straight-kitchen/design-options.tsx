...
const options = [
  { text: 'Overhead Storage', description: 'Maximize space with upper cabinets.', icon: <Layers className="size-8 text-primary" /> },
  { text: 'With Tall Unit', description: 'Integrate pantry or appliance storage.', icon: <Building className="size-8 text-primary" /> },
  { text: 'Handleless Design', description: 'Achieve a sleek, modern look.', icon: <Minus className="size-8 text-primary" /> },
  { text: 'Hidden Appliances', description: 'Seamlessly conceal your appliances.', icon: <EyeOff className="size-8 text-primary" /> },
];
    ...
    <section className="py-16 md:py-24 bg-background">
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-muted-foreground mt-4">Customize your straight kitchen to fit your lifestyle.</p>
        </div>
